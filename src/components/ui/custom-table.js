...
export default function CustomTable({
  ...
  const StatusChip = ({ status }) => {
    ...
    return (
      <span
        className={`inline-flex items-center justify-center min-w-[80px] h-7 px-3 py-1.5 rounded-full text-[10px] font-medium text-center uppercase ${
  ...
  return (
    <div className='flex flex-col gap-4 bg-white rounded-xl p-4 shadow-sm overflow-x-auto'>
